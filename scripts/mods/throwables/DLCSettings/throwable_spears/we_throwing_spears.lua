local AXE_HIT_EFFECT = "melee_hit_sword_1h"
...
weapon_template.actions = {
	action_one = {
		default = {
			...
			projectile_info = Projectiles.throwing_spears,
			impact_data = {
				wall_nail = true,
				depth = 0.15,
				depth_damage_modifier_min = 1,
				link_pickup = true,
				damage_profile = "throwing_spear",
		...
		throw_charged = {
			...
			impact_data = {
				...
				depth_damage_modifier_min = 1,
				link_pickup = true,
				damage_profile = "throwing_spear_charged",
				no_stop_on_friendly_fire = true,
				depth_damage_modifier_max = 1.2,
				depth_offset = -0.6,
				--targets = 3,
...
weapon_template.default_spread_template = "throwing_spears"
...
return {
	we_throwing_spears_template = table.clone(weapon_template)
}